...
import { ParecerDialogComponent } from '../../../../../../main/webapp/app/entities/parecer/parecer-dialog.component';
...
import { ProcessoService } from '../../../../../../main/webapp/app/entities/processo';

describe('Component Tests', () => {

    describe('Parecer Management Dialog Component', () => {
        let comp: ParecerDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ParecerDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'parecerListModification', content: 'OK'});
